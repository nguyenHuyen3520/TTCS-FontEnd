            ...
            <div className="Home">
                <div className="Home__homeHero">
                    <div className="Home__homeHero__text">
                        ...
                        <button onClick={() => history.push('/courses')}>View Course</button>
                    </div>
                </div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', paddingTop: '36px' }}>
                        <div>
                            ...
                            <div style={{ fontSize: '1.25rem' }}>
                                ...
                                <button className='Home__section3__button1' onClick={() => history.push('/signup')}>Sign up </button>
                                <button className='Home__section3__button2' onClick={() => history.push('/login')}>Login </button>
                            </div>
                        </div>
                    </div>
                    <div className='Home__section__separate'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1430 140" fill="#303030" class="makeStyles-bottomSwoop-866"><path d="M0 140h1440V46.75C1360.635 15.583 1268.302 0 1163 0 812.13 0 674 113.78 370.736 127.279 188.866 135.374 65.286 119.625 0 80.03V140z"></path></svg>
                    </div>
                </div>
                ...
                <div className="Home__section5">
                    ...
                    <div>
                        ...
                        <div className="Home__section5__item float-right">
                            <h1>2</h1>
                            <div className="Home__section5__item__des">
                        ...
                        <div className="Home__section5__item clear-both">
                            <h1>3</h1>
                            <div className="Home__section5__item__des">
                    ...
                    <div style={{ paddingTop: "5px" }} className='Home__section__separate'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1430 140" fill="#303030" class="makeStyles-bottomSwoop-866"><path d="M0 140h1440V46.75C1360.635 15.583 1268.302 0 1163 0 812.13 0 674 113.78 370.736 127.279 188.866 135.374 65.286 119.625 0 80.03V140z"></path></svg>
                    </div>
                </div>
